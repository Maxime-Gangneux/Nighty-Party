...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 07 mai 2024 à 07:23
...
INSERT INTO `soiree` (`id_soiree`, `nom_soiree`, `description_soiree`, `adresse_soiree`, `date_soiree`, `heure_min_soiree`, `heure_max_soiree`, `nb_personne_soiree`, `theme_soiree`, `type_soiree`, `statu_soiree`, `code_soiree`) VALUES
...
(13, 'Projet X', 'Salut on organise un événement pour les étudiant qui veulent faire la fête et s amusere entre amis.  Ne vous inquiétez pas il y aura de lalcool a disp', '20 rue d hesingue, Romagny', '2024-05-18', '21:20:00', '03:30:00', 150, 'Classe/ bien habiller', 'Projet X', 1, NULL);
